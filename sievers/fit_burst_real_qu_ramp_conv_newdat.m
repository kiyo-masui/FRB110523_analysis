...
if ~exist('dat')
  ...
  best_guess=load('initial_conditions/phase_ramp_convolved_mean.txt');
  mycov=load('initial_conditions/phase_ramp_convolved_cov.txt');
end
...
[pp,ll,nvec]=mcmc_burst_real_qu_complex(dat_q,dat_u,myopts,freq_use,best_guess,0.5*mycov,dt);
